...
if(localStorage.getItem("Language") === "hu") {
    ...
    kozepszoveg.innerHTML =  `Asztalitenisz eredmények`;
}
...
if(localStorage.getItem("Language") === "de") {
    ...
    kozepszoveg.innerHTML =  `Tischtennis Resultat`;
}
...
if(localStorage.getItem("Language") === "en") {
    ...
    kozepszoveg.innerHTML =  `Table Tennis Results`;
...
if(localStorage.getItem("Language") === "fr") {
    ...
    kozepszoveg.innerHTML =  `Tennis de Table Résultats`;
