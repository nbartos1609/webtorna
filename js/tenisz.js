...
if(localStorage.getItem("Language") === "hu") {
    ...
    kozepszoveg.innerHTML =  `Tenisz eredmények`;
}
...
if(localStorage.getItem("Language") === "de") {
    ...
    kozepszoveg.innerHTML =  `Tennis Resultat`;
...
if(localStorage.getItem("Language") === "en") {
    ...
    kozepszoveg.innerHTML =  `Tennis Results`;
...
if(localStorage.getItem("Language") === "fr") {
    ...
    kozepszoveg.innerHTML =  `Tennis Résultats`;
